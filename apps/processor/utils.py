...
#     summary_ws.append(["Source File", "Sheet Name"])
...
#                                 sheet_title = f"{os.path.splitext(file)[0]}_{sheet_name}"[:200]

#                                 # Add to master workbook as a new sheet
...
#                                 # Add source file and sheet name to summary.xlsx
#                                 summary_ws.append([file, sheet_name])
...
def process_folder(folder_path):
    ...
    real_sheets_added = False  # Track if real sheets added
                    ...
                    if file.endswith(('.xlsx', '.xls')):
                        ...
                        try:
                            ...
                            for sheet_name in xls.sheet_names:
                                ...
                                # c3 = openpyxl_ws['C3'].value

                                summary_ws.append([file, sheet_name, d14,d5])

                                real_sheets_added = True  # Mark that we added at least one sheet
